...
START_TEST(test_curve25519_agreement)
{
    ...
    uint8_t alicePublic[] = {
            0x1b, 0xb7, 0x59, 0x66, 0xf2,
            0xe9, 0x3a, 0x36, 0x91, 0xdf,
            0xff, 0x94, 0x2b, 0xb2, 0xa4,
            0x66, 0xa1, 0xc0, 0x8b, 0x8d,
            0x78, 0xca, 0x3f, 0x4d, 0x6d,
            0xf8, 0xb8, 0xbf, 0xa2, 0xe4,
            0xee, 0x28};
    ...
    uint8_t bobPublic[] = {
            0x65, 0x36, 0x14, 0x99, 0x3d,
            0x2b, 0x15, 0xee, 0x9e, 0x5f,
            0xd3, 0xd8, 0x6c, 0xe7, 0x19,
            0xef, 0x4e, 0xc1, 0xda, 0xae,
            0x18, 0x86, 0xa8, 0x7b, 0x3f,
            0x5f, 0xa9, 0x56, 0x5a, 0x27,
            0xa2, 0x2f};
...
START_TEST(test_curve25519_signature)
{
    ...
    uint8_t aliceEphemeralPublic[] = {
            0xed, 0xce, 0x9d, 0x9c, 0x41, 0x5c, 0xa7, 0x8c,
            0xb7, 0x25, 0x2e, 0x72, 0xc2, 0xc4, 0xa5, 0x54,
            0xd3, 0xeb, 0x29, 0x48, 0x5a, 0x0e, 0x1d, 0x50,
            0x31, 0x18, 0xd1, 0xa8, 0x2d, 0x99, 0xfb, 0x4a};

    uint8_t aliceSignature[] = {
            0x08, 0x71, 0x89, 0x8e, 0xeb, 0x9e, 0xcd, 0x1d,
            0x70, 0x02, 0xcb, 0xf5, 0x99, 0x7e, 0xff, 0x92,
            0xed, 0x11, 0x3f, 0x36, 0xbf, 0xc8, 0xfc, 0x1e,
            0x19, 0x4e, 0xaf, 0x6a, 0x59, 0x94, 0x35, 0x03,
            0xfd, 0x8e, 0xfd, 0xea, 0x60, 0x23, 0x48, 0xfd,
            0x56, 0xd2, 0xa4, 0x17, 0xcc, 0x75, 0x04, 0x29,
            0xf4, 0x17, 0xe9, 0xf5, 0x76, 0x4d, 0x0a, 0x95,
            0x1f, 0x10, 0x4a, 0x82, 0x7b, 0x4a, 0xf8, 0x80};
